...
public void OnPluginStart()
{
    ...
    g_cDPrice = AutoExecConfig_CreateConVar("hs_detective_price", "3000", "The amount of credits for healthshot costs as detective. 0 to disable.");
    ...
    g_cDCount = AutoExecConfig_CreateConVar("hs_detective_count", "2", "The amount of usages for healthshots per round as detective. 0 to disable.");

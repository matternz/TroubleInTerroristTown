...
public void OnPluginStart()
{
    ...
    g_cAWP_Min_Shots = AutoExecConfig_CreateConVar("awp_min_shots", "3", "The min. amount of shots of traitor awp.");
    g_cAWP_Max_Shots = AutoExecConfig_CreateConVar("awp_max_shots", "5", "The max. amount of shots of traitor awp.");
    ...
    g_cBC_Min = AutoExecConfig_CreateConVar("bc_min", "3", "The min. amount of breachcharges.");
    ...
    g_cHammer_Price = AutoExecConfig_CreateConVar("hammer_price", "1000", "The amount of credits the Hammer costs. 0 to disable.");
    g_cHammer_Prio = AutoExecConfig_CreateConVar("hammer_sort_prio", "0", "The sorting priority of the Hammer in the shop menu.");
    g_cHammer_Type = AutoExecConfig_CreateConVar("hammer_type", "2", "Type of hammer configuration to use. 0 = Everyone, 1 = Traitor + Detective (Default), 2 = Traitor Only");
    g_cAxe_Long = AutoExecConfig_CreateConVar("axe_name", "Axe", "The name of the Axe in the shop menu.");
    g_cAxe_Price = AutoExecConfig_CreateConVar("axe_price", "1000", "The amount of credits the Axe costs. 0 to disable.");
    g_cAxe_Prio = AutoExecConfig_CreateConVar("axe_sort_prio", "0", "The sorting priority of the Axe in the shop menu.");
    g_cAxe_Type = AutoExecConfig_CreateConVar("axe_type", "2", "Type of Axe configuration to use. 0 = Everyone, 1 = Traitor + Detective (Default), 2 = Traitor Only");
    g_cSpanner_Long = AutoExecConfig_CreateConVar("spanner_name", "Spanner", "The name of the Spanner in the shop menu.");
    g_cSpanner_Price = AutoExecConfig_CreateConVar("spanner_price", "1000", "The amount of credits the Spanner costs. 0 to disable.");
    g_cSpanner_Prio = AutoExecConfig_CreateConVar("spanner_sort_prio", "0", "The sorting priority of the Spanner in the shop menu.");
    g_cSpanner_Type = AutoExecConfig_CreateConVar("spanner_type", "2", "Type of Spanner configuration to use. 0 = Everyone, 1 = Traitor + Detective (Default), 2 = Traitor Only");
    TTT_EndConfig();
